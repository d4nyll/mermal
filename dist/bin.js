...
program.option('-b, --base <baseFile>', 'Path to the base YAML file where other files will be merged into').option('-o, --out <outFile>', 'Path to the YAML file that will be exported to. It will override any existing files').option('-s, --search <searchDir>', 'A directory that will be searched for', collect, []).parse(process.argv);
